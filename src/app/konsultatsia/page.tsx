  ...
  return (
    <>
      <PageHero
        ...
        sub="Консултацията е първата и най-важна стъпка към здрава и балансирана кожа. Разглеждаме кожата ви отблизо, говорим за навиците и целите ви, а накрая си тръгвате с личен план за професионална и домашна грижа."
      >
        <Reveal delay={0.1}>
