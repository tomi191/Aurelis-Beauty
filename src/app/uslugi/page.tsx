  ...
  return (
    <>
      <PageHero
        ...
        sub="Преди всяка процедура правим анализ на кожата, а след нея си тръгвате с план. Разгледайте категориите или елате първо на консултация, за да изберем заедно."
      />
